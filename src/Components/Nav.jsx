...
const Nav = () => {
  ...
  return (
    <nav className=" top-0 left-0 w-full bg-[#E0F2FE] py-4 px-6 shadow-md z-50">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className="sm:hidden">
          <button
            ...
            className="text-[#0284C7] focus:outline-none"
          >
        ...
        <div className="hidden sm:flex sm:items-center sm:space-x-6">
          <Link onClick={() => setIsSidebarOpen(false)} to={"/"} className="text-[#0284C7] hover:text-[#38BDF8] font-medium transition-colors duration-300">
            Dashboard
          </Link>
          <Link onClick={() => setIsSidebarOpen(false)} to={"/Db-Lab"} className="text-[#0284C7] hover:text-[#38BDF8] font-medium transition-colors duration-300">
            DB-Lab
          </Link>
          <Link onClick={() => setIsSidebarOpen(false)} to={"/order"} className="text-[#0284C7] hover:text-[#38BDF8] font-medium transition-colors duration-300">
            Order-recived
          </Link>
        </div>
      ...
      >
        <div className="flex justify-between items-center px-6 py-4 border-b">
          <div className="text-2xl font-bold text-[#0284C7]">Admin</div>
          <button
            onClick={() => setIsSidebarOpen(false)}
            className="text-[#0284C7] focus:outline-none"
          >
        ...
        <motion.div className="flex flex-col px-6 py-4 space-y-4">
          ...
          <motion.div variants={itemVariants}>
            <Link onClick={() => setIsSidebarOpen(false)} to={"/checked"} className="text-[#0284C7] hover:text-[#38BDF8] font-medium transition-colors duration-300">
              Order-Completed
            </Link>
          </motion.div>
        </motion.div>
